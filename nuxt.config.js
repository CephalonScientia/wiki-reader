export default {
  ...
  head: {
    title: process.env.APP_NAME || "[PH] Wiki Reader",
    htmlAttrs: {
      lang: "en",
    },
    meta: [
  ...
  // Modules for npm run dev and build (recommended): https://go.nuxtjs.dev/config-modules
  buildModules: [
